...
export default function AboutPage() {
	return (
		<div className='my-20 mx-auto flex flex-col justify-center'>
			<Flip><h1 className='text-center text-4xl font-bold my-10'>About Me</h1></Flip>
				...
				<div className='my-10 md:mx-20'>
					<div className=" w-full">
						<div className="h-full bg-gray-100 p-8 rounded">
							...
							<p className="leading-relaxed mb-6"><Fade>Hello this is Pradeep Kumar Rebbavarapu. Made this Website using Next.js a Frontend React.js ssr Framework And is Deployed On Vercel .The Backend is 
							Made Using django and Deployed on Python Anywhere. Do Comment On How My Website Looks. Feel Free To 
							Tell Any Bugs On My Website. </Fade></p>
							<a className="inline-flex items-center">
								
								<span className="flex-grow flex flex-col pl-4">
									<Flip>
									<span className="title-font font-medium text-gray-900 uppercase">Pradeep Kumar.R</span></Flip>
									<Flip>
					...
					<div className=" w-full my-10">
						<div className="h-full bg-gray-100 p-8 rounded">
							...
							<p className="leading-relaxed mb-6"><Fade> My Team Consists of My Self And My Hp Omen Pc. My Personal Skills are Mentioned Below Do Have a Look on It. Hopefully i Will Be Able to Make Better Wesbites Over My Experience. </Fade></p>
							 
							<a className="inline-flex items-center">
								
								<san className="flex-grow flex flex-col pl-4">
									<Flip>
									<span className="title-font font-medium text-gray-900 uppercase">Hp Omen Pc</span></Flip>
									<Flip>
									<span className="text-gray-500 text-sm">My Team</span>
									</Flip>
								</san>
							</a>
						</div>
